...
export default function SealTeamPage() {
  const data = getKidsProgramBySlug("padi-seal-team-kids-havelock")!;

  return (
    <main>
      {/* ── HERO ── */}
      <section className="relative min-h-[55vh] sm:min-h-[65vh] flex items-end overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-teal-900/80 via-deep-950 to-emerald-900/60" />
      ...
      <section className="relative py-16 sm:py-20 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Book the {data.shortTitle} program today and give your child an unforgettable underwater adventure
          </motion.p>
          <motion.div
